...
const Quiz = ({ isLoggedIn, onShowLoginModal }) => {
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      ...
      setError(null);
      try {
        const res = await fetch('https://aistudylab.onrender.com/api/admin/questions');
    ...
    const fetchQuestions = async () => {
      ...
      try {
        ...
        if (selectedSubject.toLowerCase() === 'maths') {
          const res = await fetch('https://aistudylab.onrender.com/api/data/math-questions?category=general&limit=100');
          data = await res.json();
          ...
          const res = await fetch('https://aistudylab.onrender.com/api/data/math-questions?category=science&limit=100');
          data = await res.json();
          ...
          const res = await fetch('https://aistudylab.onrender.com/api/data/math-questions?category=history&limit=100');
          data = await res.json();
          ...
          const res = await fetch(`https://aistudylab.onrender.com/api/quiz?subject=Computer Science&limit=100`);
          data = await res.json();
          ...
          const res = await fetch(`https://aistudylab.onrender.com/api/quiz?subject=${encodeURIComponent(selectedSubject)}`);
          data = await res.json();
        }
