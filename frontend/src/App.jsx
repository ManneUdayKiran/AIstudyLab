...
function App() {
  ...
  const handleEditComplete = async (profileData) => {
    ...
    try {
      ...
      const response = await fetch('https://aistudylab.onrender.com/api/auth/profile', {
        method: 'PUT',
        headers: {
...
function LearningPage({ isLoggedIn, onShowLoginModal }) {
  ...
  React.useEffect(() => {
    const fetchCS = async () => {
      try {
        const res = await fetch('https://aistudylab.onrender.com/api/data/learning');
    ...
    const fetchMaths = async () => {
      try {
        const res = await fetch('https://aistudylab.onrender.com/api/data/maths-learning');
        const json = await res.json();
    ...
    const fetchDS = async () => {
      try {
        const res = await fetch('https://aistudylab.onrender.com/api/data/datascience-learning');
        const json = await res.json();
        setDSData(json.data || []);
      } catch {
        setDSData([]);
    ...
    const fetchScience = async () => {
      try {
        const res = await fetch('https://aistudylab.onrender.com/api/data/science-learning');
        const json = await res.json();
